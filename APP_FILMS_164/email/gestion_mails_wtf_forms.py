...
class FormWTFUpdateGenre(FlaskForm):
    ...
    nom_genre_update_wtf = StringField("Clavioter le mail ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFDeleteGenre(FlaskForm):
    ...
    """
    nom_genre_delete_wtf = StringField("Effacer ce mail")
