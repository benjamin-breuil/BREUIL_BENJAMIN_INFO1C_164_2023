...
@app.route("/emails_afficher/<string:order_by>/<int:id_genre_sel>", methods=['GET', 'POST'])
def emails_afficher(order_by, id_genre_sel):
    ...
    return render_template("mails/mails_afficher.html", data=data_genres)
...
@app.route("/email_delete", methods=['GET', 'POST'])
def email_delete_wtf():
