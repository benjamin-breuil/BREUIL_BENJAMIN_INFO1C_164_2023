...
class FormWTFUpdateGenre(FlaskForm):
    ...
    update_npa_adresse_wtf = StringField("Clavioter le code postal ", validators=[
        Length(min=2, max=20, message="min 2 max 20"),
        Regexp(num_genre_regexp, message="Seuls les chiffres sont autorisés")
    ])


    update_nom_genre_wtf = StringField("Clavioter la rue ", validators=[Length(min=2, max=200, message="min 2 max 20"),
                                                                   Regexp(nom_genre_regexp,
                                                                          message="Pas de chiffres, de caractères "
                                                                                  "spéciaux, "
                                                                                  "d'espace à double, de double "
    ...
    update_num_rue_adresse_wtf = StringField("Clavioter le numéro de rue ", validators=[
        Length(min=2, max=20, message="min 2 max 20"),
        Regexp(num_genre_regexp, message="Seuls les chiffres sont autorisés")
    ])

    update_ville_adresse_wtf = StringField("Clavioter la ville ", validators=[Length(min=2, max=200, message="min 2 max 20"),
                                                                   Regexp(nom_genre_regexp,
                                                                          message="Pas de chiffres, de caractères "
                                                                                  "spéciaux, "
                                                                                  "d'espace à double, de double "
    ...
    update_pays_adresse_wtf = StringField("Clavioter le pays ", validators=[Length(min=2, max=200, message="min 2 max 20"),
                                                                   Regexp(nom_genre_regexp,
                                                                          message="Pas de chiffres, de caractères "
                                                                                  "spéciaux, "
                                                                                  "d'espace à double, de double "
